                            ...
                            {loginRequired && shop.phone && (
                              <div className="mt-5">
                                <motion.div
                                  ...
                                  className="relative rounded-2xl border-2 border-[#25D366] bg-white/5 p-4 pt-5"
                                >
                                  {/* Badge */}
                                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                                    <div className="inline-flex items-center gap-1.5 rounded-full bg-[#25D366] px-3 py-1 text-xs font-bold text-white shadow-md">
                                  ...
                                  <p className="text-center text-sm font-semibold text-zinc-800 dark:text-zinc-100">
                                    ¡Escaneá y chateá con la barbería!
                                  </p>
                                  <p className="text-center text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                                    Sacá tus dudas directo por WhatsApp
                                  </p>

                                  {qrCodeUrl && (
                                    <div className="flex justify-center mt-3">
                                      <div className="relative inline-flex p-1.5 rounded-xl bg-white shadow-inner">
                                        <motion.div
                                          initial={{ rotate: -2 }}
                                          animate={{ rotate: 2 }}
                                  ...
                                  <p className="text-center text-xs text-zinc-400 dark:text-zinc-500 mt-2">
                                    <a
                                      ...
                                      className="text-[#25D366] hover:text-[#1da851] transition-colors font-medium underline underline-offset-2"
                                    >
                                      {shop.phone}
                                    </a>
                                  </p>
