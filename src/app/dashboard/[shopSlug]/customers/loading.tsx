  ...
  return (
    <div className="space-y-6 animate-pulse">
      <div>
        ...
        <div className="mt-1 h-4 w-56 bg-white/20 dark:bg-white/10 rounded-full" />
      </div>
      <div className="flex gap-2">
        <div className="h-9 w-36 bg-white/20 dark:bg-white/10 rounded-full" />
        <div className="h-9 w-20 bg-white/20 dark:bg-white/10 rounded-full" />
      </div>
      <div className="h-10 w-72 bg-white/20 dark:bg-white/10 rounded-full" />
        ...
        <div className="divide-y divide-white/10">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="flex items-center gap-4 px-4 sm:px-6 py-4">
              ...
              <div className="h-4 w-24 bg-white/20 dark:bg-white/10 rounded-full hidden sm:block" />
              <div className="h-4 w-20 bg-white/20 dark:bg-white/10 rounded-full hidden lg:block" />
            </div>
          ))}
        </div>
      </div>
