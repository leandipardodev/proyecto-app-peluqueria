        ...
        <div className="relative">
          <input
            ...
            className={cn(
              ...
              error
                ? "border-red-400 bg-red-50/30 focus:ring-red-400 dark:border-red-500 dark:bg-red-950/30"
                : "border-gray-300 bg-white dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500",
              rightElement && "pr-10",
              className
            )}
            aria-invalid={!!error}
