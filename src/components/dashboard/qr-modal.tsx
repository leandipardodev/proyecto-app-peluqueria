...
export default function QRModal({ open, bookingUrl, onClose }: QRModalProps) {
  ...
  return (
    <BaseModal open={open} onClose={onClose} title="Código QR" maxWidth="sm" icon={<QrCode className="w-5 h-5 text-violet-600" />}>
      ...
      <div className="px-5 pb-5 flex flex-col gap-2">
        ...
        <button
          ...
          onClick={showPDF}
          disabled={!qrDataUrl}
          className="ui-btn-ghost inline-flex items-center justify-center gap-2 rounded-lg px-5 py-2.5 text-sm font-medium"
        >
