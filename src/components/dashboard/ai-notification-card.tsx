  ...
  return (
    <button type="button" onClick={handleClick} className="group block h-full w-full text-left">
      <div className="relative h-[148px] md:h-[156px]">
        ...
        <div className="ai-orb-wrap relative h-full overflow-hidden rounded-[2rem] rounded-bl-none border border-cyan-300/30 bg-white p-4 text-cyan-950 shadow-[0_20px_48px_rgba(8,145,178,0.28)] transition-transform duration-300 group-hover:-translate-y-0.5 dark:bg-zinc-900 dark:text-cyan-50">
