      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xl w-full max-w-xl overflow-hidden max-h-[92dvh] flex flex-col my-4"
          >
